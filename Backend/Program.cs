...
builder.Services.AddScoped<IPointSystemService, PointSystem_service>();
builder.Services.AddScoped<IEventAttendanceService, EventAttendanceService>();
builder.Services.AddScoped<IEventService, Event_service>();
builder.Services.AddScoped<IAttendanceService, Attendance_service>();
