...
namespace Web_Development.Migrations
{
    ...
    [Migration("20250111124439_DataMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventAttendance_model", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("User", b =>
                {
                    b.OwnsOne("UserPoints_model", "Points", b1 =>
                        {
                            ...
                            b1.OwnsMany("ShopItems", "Items", b2 =>
                                {
                                    b2.Property<Guid>("UserPoints_modelUserId")
                                        .HasColumnType("TEXT");
                                    ...
                                    b2.HasKey("UserPoints_modelUserId", "Id");

                                    b2.ToTable("ShopItems");

                                    b2.WithOwner()
                                        .HasForeignKey("UserPoints_modelUserId");
                                });
